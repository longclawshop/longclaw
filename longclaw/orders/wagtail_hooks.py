...
"""
TODO: Rather than use the button helper it could be controlled via permissions
"""
...
#         btns.append(self.detail_button(pk, classnames_add, classnames_exclude))
...
#         context = {"order_id": self.instance.id, "api_url_prefix": API_URL_PREFIX}
...
class OrderModelAdmin(ModelAdmin):
    ...
    #     urls = urls + (
    #         path(
    #             self.url_helper.get_action_url_pattern("detail"),
    #             self.detail_view,
