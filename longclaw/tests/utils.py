...
class LongclawTestCase(APITestCase):
    def get_test(
        self, urlname, urlkwargs=None, params=None, success_expected=True, **kwargs
    ):
        ...
        response = self.client.get(
            reverse_lazy(urlname, kwargs=urlkwargs), params, **kwargs
        )
        if success_expected:
    ...
    def post_test(self, data, urlname, urlkwargs=None, success_expected=True, **kwargs):
        ...
        response = self.client.post(
            reverse_lazy(urlname, kwargs=urlkwargs), data, **kwargs
        )
        if success_expected:
            self.assertTrue(status.is_success(response.status_code), response.content)
        return response
    ...
    def patch_test(
        self, data, urlname, urlkwargs=None, success_expected=True, **kwargs
    ):
