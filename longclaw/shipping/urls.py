...
urlpatterns = [
    path(API_URL_PREFIX + r'addresses/$',
        address_list,
        name='longclaw_address_list'),
    path(API_URL_PREFIX + r'addresses/(?P<pk>[0-9]+)/$',
        address_detail,
        name='longclaw_address_detail'),
    path(API_URL_PREFIX + r'shipping/cost/$',
        api.shipping_cost,
        name='longclaw_shipping_cost'),
    path(API_URL_PREFIX + r'shipping/countries/$',
        api.shipping_countries,
        name='longclaw_shipping_countries'),
    path(API_URL_PREFIX + r'shipping/countries/(?P<country>[a-zA-Z]+)/$',
        api.shipping_options,
        name='longclaw_shipping_options'),
    path(API_URL_PREFIX + r'shipping/options/$',
        api.shipping_options,
